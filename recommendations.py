...
def build_summary(data: dict) -> str:
    ...
    return (
        ...
        f"Схоже, основна складність зараз пов’язана з: {readable_branch}.\n\n"
        "Після цього діалогу не потрібно одразу вирішувати всю ситуацію.\n"
        "Краще дати нервовій системі час стабілізуватися: спокійніше середовище, повільне дихання, менше стимулів.\n\n"
        "Якщо стан повторюється, триває довго або заважає спати, навчатись, працювати чи спілкуватися — "
